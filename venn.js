...
/// Uses multidimensional scaling to approximate a first layout here
  ...
  function centerVennDiagram(diagram, width, height, padding) {
    ...
    if (diagram) {
      diagramBoundaries = diagram.node().getBBox();
  ...
  venn.drawD3Diagram = function(element, dataset, width, height, parameters) {
    ...
    var colours = scaleOrdinal(schemeCategory10),
      ...
      circleStrokeWidth = parameters.circleStrokeWidth || function(i) {
          return 0;
        },
    ...
    var circles = nodes.append("circle")
      ...
      .style("stroke", function(d, i) {
        return circleStrokeColours(i);
      })
      .style("stroke-width", function(d, i) {
        return circleStrokeWidth(i);
      })
      .style("fill", function(d, i) {
        return circleFillColours(i);
      });
    ...
    var text = nodes.append("text")
      ...
      .attr("dy", "0.35em")
      .style("stroke", function(d, i) {
        return textStrokeColours(i);
      })
      .style("fill", function(d, i) {
        return textFillColours(i);
      })
      .text(function(d) {
        return d.label;
      });
...
function initCircleIntersection() {
...
const circleIntersection = initCircleIntersection()
const venn               = initVenn()
